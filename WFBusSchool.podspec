...
Pod::Spec.new do |s|
  s.name             = 'WFBusSchool'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WFBusSchool.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wyxlh/WFBusSchool'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wyxlh' => 'wy_wangyu163@163.com' }
  s.source           = { :git => 'https://github.com/wyxlh/WFBusSchool.git', :tag => s.version.to_s }
